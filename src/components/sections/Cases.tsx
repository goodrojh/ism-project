    ...
    <section id="cases" className="relative w-full overflow-hidden bg-navy px-4 py-[90px] text-white blueprint-grid md:px-6 md:py-[120px]">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        <SectionHeading
          align="left"
          dark
          title="Объекты команды — с цифрами, а не картинками"
          text="Площадь, срок и результат экспертизы по каждому объекту, в котором участвовали наши инженеры. Полное портфолио с контактами заказчиков — по запросу."
          action={
